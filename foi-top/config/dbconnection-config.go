...
func ExecuteQuery( exec func(*gorm.DB) *gorm.DB )*gorm.DB {
			db:= GetDbConnection()
...
func GetDbConnection() *gorm.DB {
	...
	if err!=nil {
		...
		log.Println("Erro ao inicializar conexao com banco  de dados , profile  ",err,profile)
		defer db.Close()
	}
